 ...
 */
public class ZookeeperDockerBuilder extends  BothTypesDockersBuilder {


	private static final Logger logger = LoggerFactory.getLogger(ZookeeperDockerBuilder.class);


	private static final String name = "zookeeper";

	public ZookeeperDockerBuilder(AbstractDockersBuilder builder) {
		super(builder);

		logger.debug("zk builder name    "+ name);
	}
